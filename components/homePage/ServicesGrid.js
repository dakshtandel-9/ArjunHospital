        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {services.map((service, index) => (
            <Link
              ...
              className="group block bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-4 sm:p-6 border border-gray-200"
            >
              <div className={`inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 ${service.bgColor} rounded-lg mb-3 sm:mb-4`}>
                <div className={`${service.iconColor} group-hover:scale-110 transition-transform`}>
                  {service.icon}
                </div>
              </div>
          ...
          <span className="inline-flex items-center text-blue-600 font-semibold">View details
