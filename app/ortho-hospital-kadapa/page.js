...
export const metadata = { title: "Ortho Hospital in Kadapa - Arjun Hospital" };

export default function OrthoHospitalKadapaPage() {
  const siteUrl = getBaseUrl();
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Ortho Hospital in Kadapa",
    ...
    <section className="py-16 bg-gray-50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">Ortho Hospital in Kadapa</h1>
          <p className="text-base sm:text-lg text-gray-700 max-w-3xl mx-auto">
            Fracture care, joint disorders, sports injuries, and spine problems managed with conservative therapy and surgical expertise. Pain relief, mobility restoration, and guided rehab.
          </p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-gray-700">
                <li>Casts, braces, immobilization</li>
